...
const messages = {
  en: {
    ...
    upload: {
      siteName: "Site name", optional: "optional", siteNamePlaceholder: "e.g. My Portfolio",
    ...
    deployments: {
      title: "Deployment History", total: (count: number) => `${count} ${count === 1 ? "deployment" : "deployments"} total`,
    ...
    detail: {
      ...
      deployId: "Deploy ID", fileCount: "File count", totalSize: "Total size", source: "Source", name: "Name", deployedAt: "Deployed at",
      newDeployment: "New deployment", viewAll: "View all",
    },
    settings: {
  ...
  zh: {
    ...
    upload: {
      siteName: "站点名称", optional: "可选", siteNamePlaceholder: "例如：我的作品集", apiUrl: "后端 API 地址", apiUrlPlaceholder: "例如：https://api.example.com",
      apiUrlHelp: "如果前端需要后端 API，请在这里填写地址。它将在应用中通过以下变量访问：", dropTitle: "将构建产物拖到这里", dropDescription: "拖入", orA: "或选择一个", folder: "文件夹",
    ...
    deployments: {
      title: "部署记录", total: (count: number) => `共 ${count} 次部署`, newDeployment: "新建部署", noDeployments: "还没有部署记录", noDeploymentsHelp: "上传你的第一个静态网站即可开始。",
      uploadNow: "立即上传", nameId: "名称 / ID", files: "文件数", size: "大小", deployed: "部署时间", view: "查看 →", loadError: "加载部署记录失败",
    },
    detail: {
      success: "部署成功！", successHelp: "你的网站已经上线，可以分享了。", liveUrl: "访问地址", openSite: "打开网站", deployId: "部署 ID", fileCount: "文件数", totalSize: "总大小", source: "来源", name: "名称", deployedAt: "部署时间", newDeployment: "新建部署", viewAll: "查看全部",
    },
    settings: {
